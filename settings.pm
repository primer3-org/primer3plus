...
my %defaultNewSettings = (
  "SEQUENCE_ID"=>"empty",
  "SEQUENCE_TEMPLATE"=>"empty",
  "SEQUENCE_INCLUDED_REGION"=>"empty",
  "SEQUENCE_TARGET"=>"empty",
  "SEQUENCE_EXCLUDED_REGION"=>"empty",
  "SEQUENCE_PRIMER_OVERLAP_POS"=>"empty",
  "SEQUENCE_INTERNAL_EXCLUDED_REGION"=>"empty",
  "SEQUENCE_PRIMER"=>"empty",
  "SEQUENCE_INTERNAL_OLIGO"=>"empty",
  "SEQUENCE_PRIMER_REVCOMP"=>"empty",
  "SEQUENCE_START_CODON_POSITION"=>"-1000000",
