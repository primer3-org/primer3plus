...
# Primer3 "Global" Input Tags
  ...
  "PRIMER_INTERNAL_MAX_TEMPLATE_MISHYB_TH"   => "-1.0",
  "PRIMER_PAIR_MAX_TEMPLATE_MISPRIMING_TH"   => "-1.0",
  "PRIMER_WT_TEMPLATE_MISPRIMING_TH"         => "0.0",
  "PRIMER_INTERNAL_WT_TEMPLATE_MISHYB_TH"    => "0.0",
...
PRIMER_INTERNAL_MAX_TEMPLATE_MISHYB_TH => "PRIMER_INTERNAL_MAX_TEMPLATE_MISHYB_TH",
...
PRIMER_INTERNAL_WT_TEMPLATE_MISHYB_TH => "PRIMER_INTERNAL_WT_TEMPLATE_MISHYB_TH",
